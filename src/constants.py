...
ZONES: dict[str, Zone] = {
    "teso_kyoga": Zone(
        ...
        candidate=(
            ...
            "Soroti", "Serere", "Ngora", "Kumi", "Bukedea", "Kaberamaido", "Kalaki",
            # Lango shore of Lake Kyoga
            "Amolatar", "Dokolo", "Otuke", "Alebtong",
            # Bukedi / Mpologoma wetlands
            "Pallisa", "Butaleja", "Kibuku", "Budaka", "Butebo",
        ),
    ...
    "elgon": Zone(
        ...
        core=(
            "Bududa", "Bulambuli", "Sironko", "Manafwa", "Namisindwa",
            "Mbale", "Kapchorwa", "Kween", "Bukwo",
        ),
    ...
    "karamoja": Zone(
        ...
        regime="flash",
        core=(
            "Kaabong", "Karenga", "Kotido", "Abim", "Moroto",
            "Napak", "Nabilatuk", "Nakapiripirit", "Amudat",
        ),
